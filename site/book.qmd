...
[citation extension](extension.qmd), and a CI workflow that gives every
commit an immutable permalink, embeds that permalink in every chapter's
HTML, posts PR previews via sticky comment, and deploys the book site
to GitHub Pages.
...
- **Auto-resolved citations** through the extension. Cite by `@doi:`,
  `@pmid:`, `@arxiv:`, `@isbn:`, etc. in any chapter; the resolver runs
  once per render and caches metadata.
